...
?>
			...
			<div id="content" class="container">
				<div class="row">
					...
					<form method="post" action="delete.php?<?php global $pro_num; echo "pro_num={$pro_num}" ?>" class="form-login">
							
							
							 <div class="form-group">
								<button style='vertical-align:center;padding:10px' type="submit" data-loading-text="Deleting.." class="btn btn-primary">DELETE</button>
