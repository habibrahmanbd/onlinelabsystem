...
(typeof window !== "undefined" ? window : this, function(e, t) {
    ...
    var x = function(e) {
        var t, n, i, r, o, s, a, u, f, l, c, p, d, h, g, m, y, v, x, w = "sizzle" + 1 * new Date,
            b = e.document,
            T = 0,
            C = 0,
            k = at(),
        ...
        p = st.setDocument = function(e) {
            ...
            if (r && r !== r.top) {
                if (r.addEventListener) {
                    r.addEventListener("unload", rt, false)
                } else if (r.attachEvent) {
                    r.attachEvent("onunload", rt)
                }
            }
            g = !o(s);
        ...
        st.attr = function(e, t) {
            ...
            var r = i.attrHandle[t.toLowerCase()],
                o = r && j.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !g) : undefined;
            ...
            for (; u < o; u++) {
                if (n = i.relative[e[u].type]) {
                    ...
                    if (n[w]) {
                        ...
                        return Tt(u > 1 && xt(p), u > 1 && yt(e.slice(0, u - 1).concat({
                            value: e[u - 2].type === " " ? "*" : ""
                        })).replace(_, "$1"), n, u < r && Ct(e.slice(u, r)), r < o && Ct(e = e.slice(r)), r < o && yt(e))
                    }
                    p.push(n)
                }
            }
        ...
        u = st.select = function(e, t, r, o) {
            ...
            if (h.length === 1) {
                ...
                if (f.length > 2 && (l = f[0]).type === "ID" && n.getById && t.nodeType === 9 && g && i.relative[f[1].type]) {
                    t = (i.find["ID"](l.matches[0].replace(nt, it), t) || [])[0];
                    if (!t) {
                        return r
                    } else if (d) {
                        t = t.parentNode
                ...
                while (u--) {
                    ...
                    if (p = i.find[c]) {
                        if (o = p(l.matches[0].replace(nt, it), et.test(f[0].type) && gt(t.parentNode) || t)) {
                            f.splice(u, 1);
                            e = o.length && yt(f);
                            if (!e) {
                                H.apply(r, o);
    ...
    d.fn.extend({
        ...
        closest: function(e, t) {
            var n, i = 0,
                r = this.length,
                o = [],
                s = w.test(e) || typeof e !== "string" ? d(e, t || this.context) : 0;
            for (; i < r; i++) {
    ...
    d.Callbacks = function(e) {
        e = typeof e === "string" ? L[e] || q(e) : d.extend({}, e);
        var t, n, i, r, o, s, a = [],
            u = !e.once && [],
            f = function(c) {
                t = e.memory && c;
    ...
    d.extend({
        ...
        when: function(e) {
            var t = 0,
                n = i.call(arguments),
                r = n.length,
                o = r !== 1 || e && d.isFunction(e.promise) ? r : 0,
                s = o === 1 ? e : d.Deferred(),
                a = function(e, t, n) {
                    return function(r) {
                        t[e] = this;
    ...
    d.fn.extend({
        ...
        html: function(e) {
            return F(this, function(e) {
                ...
                if (typeof e === "string" && !it.test(e) && !ut[(tt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(et, "<$1></$2>");
                    try {
                        for (; n < i; n++) {
                            t = this[n] || {};
        ...
        domManip: function(e, t) {
            ...
            var n, i, o, s, a, u, f = 0,
                ...
                g = e[0],
                m = d.isFunction(g);
            if (m || c > 1 && typeof g === "string" && !l.checkClone && rt.test(g)) {
            ...
            if (c) {
                ...
                if (i) {
                    ...
                    if (s) {
                        ...
                        for (f = 0; f < s; f++) {
                            a = o[f];
                            if (ot.test(a.type || "") && !R.access(a, "globalEval") && d.contains(u, a)) {
                                if (a.src) {
                                    if (d._evalUrl) {
                                        d._evalUrl(a.src)
                                    }
                                } else {
                                    d.globalEval(a.textContent.replace(at, ""))
                                }
                            }
                        }
                    }
        ...
        for (; s < a; s++) {
            ...
            if (t) {
                ...
                if (i.style.display === "" && z(i)) {
                    o[s] = R.access(i, "olddisplay", xt(i.nodeName))
                }
            } else {
                r = z(i);
                if (n !== "none" || !r) {
    ...
    d.each(["height", "width"], function(e, t) {
        d.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) {
                    return Nt.test(d.css(e, "display")) && e.offsetWidth === 0 ? d.swap(e, Dt, function() {
                        return Ot(e, t, i)
                    }) : Ot(e, t, i)
                }
            },
            set: function(e, n, i) {
                var r = i && Tt(e);
                return qt(e, n, i ? Ht(e, t, i, d.css(e, "boxSizing", false, r) === "border-box", r) : 0)
            }
        }
    });
    d.cssHooks.marginRight = kt(l.reliableMarginRight, function(e, t) {
        if (t) {
            return d.swap(e, {
        ...
        _t = {
            "*": [function(e, t) {
                var n = this.createTween(e, t),
                    ...
                    s = (d.cssNumber[e] || o !== "px" && +i) && $t.exec(d.css(n.elem, e)),
                    a = 1,
                    u = 20;
                if (s && s[3] !== o) {
                    o = o || s[3];
    ...
    function Vt(e, t, n) {
        ...
        if (e.nodeType === 1 && ("height" in t || "width" in t)) {
            ...
            f = d.css(e, "display");
            l = f === "none" ? R.get(e, "olddisplay") || xt(e.nodeName) : f;
        ...
        } else if ((f === "none" ? xt(e.nodeName) : f) === "inline") {
            h.display = f
        }
    }
    ...
    function Gt(e, t, n) {
        var i, r, o = 0,
            ...
            l = f.props;
        Yt(l, f.opts.specialEasing);
        for (; o < s; o++) {
            i = Bt[o].call(f, e, l, f.opts);
            if (i) {
                return i
            }
        }
    ...
    d.each(["toggle", "show", "hide"], function(e, t) {
        ...
        d.fn[t] = function(e, i, r) {
            return e == null || typeof e === "boolean" ? n.apply(this, arguments) : this.animate(Xt(t, true), e, i, r)
        }
    });
    d.each({
        slideDown: Xt("show"),
    ...
    d.fx.start = function() {
        if (!Mt) {
            Mt = setInterval(d.fx.tick, d.fx.interval)
        }
    };
    d.fx.stop = function() {
        clearInterval(Mt);
    ...
    d.fn.extend({
        addClass: function(e) {
            var t, n, i, r, o, s, a = typeof e === "string" && e,
                u = 0,
                f = this.length;
            if (d.isFunction(e)) {
            ...
            if (a) {
                ...
                for (; u < f; u++) {
                    n = this[u];
                    i = n.nodeType === 1 && (n.className ? (" " + n.className + " ").replace(en, " ") : " ");
                    if (i) {
                        o = 0;
                        while (r = t[o++]) {
                            if (i.indexOf(" " + r + " ") < 0) {
        ...
        removeClass: function(e) {
            var t, n, i, r, o, s, a = arguments.length === 0 || typeof e === "string" && e,
                u = 0,
                f = this.length;
            if (d.isFunction(e)) {
                return this.each(function(t) {
        ...
        val: function(e) {
            ...
            if (!arguments.length) {
                if (r) {
                    ...
                    n = r.value;
                    return typeof n === "string" ? n.replace(tn, "") : n == null ? "" : n
                }
                return
            }
            i = d.isFunction(e);
    ...
    d.extend({
        ...
        ajax: function(e, t) {
            ...
            t = t || {};
            var n, i, r, o, s, a, u, f, l = d.ajaxSetup({}, t),
                c = l.context || l,
                p = l.context && (c.nodeType || c.jquery) ? d(c) : d.event,
                h = d.Deferred(),
            ...
            b.success = b.done;
            b.error = b.fail;
            l.url = ((e || l.url || gn) + "").replace(on, "").replace(ln, mn[1] + "//");
            l.type = t.method || t.type || l.method || l.type;
            l.dataTypes = d.trim(l.dataType || "*").toLowerCase().match(A) || [""];
            if (l.crossDomain == null) {
                a = cn.exec(l.url.toLowerCase());
                l.crossDomain = !!(a && (a[1] !== mn[1] || a[2] !== mn[2] || (a[3] || (a[1] === "http:" ? "80" : "443")) !== (mn[3] || (mn[1] === "http:" ? "80" : "443"))))
            }
            ...
            l.hasContent = !fn.test(l.type);
            i = l.url;
            if (!l.hasContent) {
                if (l.data) {
                    i = l.url += (rn.test(i) ? "&" : "?") + l.data;
                    delete l.data
                }
                if (l.cache === false) {
                    l.url = sn.test(i) ? i.replace(sn, "$1_=" + nn++) : i + (rn.test(i) ? "&" : "?") + "_=" + nn++
                }
            }
            if (l.ifModified) {
                if (d.lastModified[i]) {
            ...
            b.setRequestHeader("Accept", l.dataTypes[0] && l.accepts[l.dataTypes[0]] ? l.accepts[l.dataTypes[0]] + (l.dataTypes[0] !== "*" ? ", " + hn + "; q=0.01" : "") : l.accepts["*"]);
            for (f in l.headers) {
    ...
    l.cors = !!Ln && "withCredentials" in Ln;
    l.ajax = Ln = !!Ln;
    d.ajaxTransport(function(e) {
        var t;
        if (l.cors || Ln && !e.crossDomain) {
            return {
                send: function(n, i) {
                    var r, o = e.xhr(),
                        s = ++Dn;
                        ...
                        return function() {
                            if (t) {
                                ...
                                if (e === "abort") {
                                    ...
                                    i(An[o.status] || o.status, o.statusText, typeof o.responseText === "string" ? {
                                        text: o.responseText
    ...
    d.ajaxPrefilter("json jsonp", function(t, n, i) {
        var r, o, s, a = t.jsonp !== false && (Hn.test(t.url) ? "url" : typeof t.data === "string" && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Hn.test(t.data) && "data");
        if (a || t.dataTypes[0] === "jsonp") {
            r = t.jsonpCallback = d.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback;
            if (a) {
                t[a] = t[a].replace(Hn, "$1" + r)
            } else if (t.jsonp !== false) {
                t.url += (rn.test(t.url) ? "&" : "?") + t.jsonp + "=" + r
            }
    ...
    d.each(["top", "left"], function(e, t) {
        d.cssHooks[t] = kt(l.pixelPosition, function(e, n) {
            if (n) {
                n = Ct(e, t);
